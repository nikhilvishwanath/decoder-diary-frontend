...
import { Route as LayoutGoalsnewImport } from './routes/_layout/goals_new'
import { Route as LayoutGoalsImport } from './routes/_layout/goals'
import { Route as LayoutDiaryImport } from './routes/_layout/diary'
...
const LayoutGoalsnewRoute = LayoutGoalsnewImport.update({
  path: '/goals_new',
  getParentRoute: () => LayoutRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/goals_new': {
      preLoaderRoute: typeof LayoutGoalsnewImport
      parentRoute: typeof LayoutImport
    }
    '/_layout/items': {
